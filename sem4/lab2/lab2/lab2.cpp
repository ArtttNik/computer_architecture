...
int main() {
    ...
    *(unsigned long long*)mmx_result = mmx_res.m64_u64;
    ...
    printf("arr1:   "); for (int i = 0; i < 8; i++) printf("%d ", mmx_arr1[i]); printf("\n");
    printf("arr2:   "); for (int i = 0; i < 8; i++) printf("%d ", mmx_arr2[i]); printf("\n");
    printf("result: "); for (int i = 0; i < 8; i++) printf("%d ", mmx_result[i]); printf("\n\n");
    ...
    printf("arr1:           "); for (int i = 0; i < 4; i++) printf("%.1f  ", sse_arr1[i]); printf("\n");
    printf("arr2:           "); for (int i = 0; i < 4; i++) printf("%.1f  ", sse_arr2[i]); printf("\n");
    ...
    printf("arr1:   "); for (int i = 0; i < 8; i++) printf("%.0f ", avx_arr1[i]); printf("\n");
    printf("arr2:   "); for (int i = 0; i < 8; i++) printf("%.0f ", avx_arr2[i]); printf("\n");
    printf("result: "); for (int i = 0; i < 8; i++) printf("%.0f ", avx_out[i]); printf("\n\n");
